package com.zhangchun.spring.annotation.component.config;

import com.zhangchun.spring.annotation.component.filterType.MyFilterType;
...
@ComponentScan(basePackages = {"com.zhangchun.spring.annotation.component"},useDefaultFilters = false,includeFilters = {
        //包含注解是Controller的
